...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
    client.Proxy("Document.prototype.write", {
        apply (ctx) {
            if (ctx.args[0]) ctx.args[0] = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.rewriteHtml)(ctx.args[0], client.cookieStore, client.meta, false);
        }
    });
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
                ...
                set (value) {
                    ...
                    if ([
                        ...
                        if (element === HTMLMediaElement && value.startsWith("blob:")) {
                            ...
                            value = (0,_shared__WEBPACK_IMPORTED_MODULE_3__.unrewriteBlob)(value);
                        } else {
                            value = (0,_shared__WEBPACK_IMPORTED_MODULE_3__.rewriteUrl)(value, client.meta);
                        }
                    } else if (attr === "srcdoc") {
    ...
    client.Proxy("Element.prototype.setAttributeNS", {
        apply (ctx) {
            ...
            if (ruleList) {
                ...
                nativeSetAttribute.call(ctx.this, `data-scramjet-${ctx.args[1]}`, value);
            }
        }
    });
    ...
    client.Trap("Element.prototype.innerHTML", {
        ...
        get (ctx) {
            if (ctx.this instanceof self.HTMLScriptElement) {
                const scriptSource = client.natives["Element.prototype.getAttribute"].call(ctx.this, "data-scramjet-script-source-src");
                if (scriptSource) {
    ...
    client.Proxy("Element.prototype.insertAdjacentHTML", {
        apply (ctx) {
            if (ctx.args[1]) ctx.args[1] = (0,_shared__WEBPACK_IMPORTED_MODULE_3__.rewriteHtml)(ctx.args[1], client.cookieStore, client.meta, false);
        }
    });
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
    client.Proxy("History.prototype.pushState", {
        apply (ctx) {
            if (ctx.args[2]) ctx.args[2] = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.rewriteUrl)(ctx.args[2], client.meta);
            ctx.call();
...
/* ESM import */var ___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! . */ "./src/client/index.ts");
// @ts-nocheck
    ...
    client.Proxy("CacheStorage.prototype.match", {
        apply (ctx) {
            if (typeof ctx.args[0] === "string" || ctx.args[0] instanceof URL) {
                ctx.args[0] = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.rewriteUrl)(ctx.args[0].toString(), client.meta);
            }
        }
    });
        ...
        apply (ctx) {
            for(let i = 0; i < ctx.args[0].length; i++){
                if (typeof ctx.args[0][i] === "string" || ctx.args[0][i] instanceof URL) {
                    ctx.args[0][i] = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.rewriteUrl)(ctx.args[0][i].toString(), client.meta);
                }
            }
        }
    });
...
function argdbg(arg, recurse = []) {
    switch(typeof arg){
        case "string":
            if (arg.includes("localhost:1337/scramjet/") && arg.includes("m3u8")) debugger;
            break;
        case "object":
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, _self) {
    client.Proxy("fetch", {
        apply (ctx) {
            if (typeof ctx.args[0] === "string" || ctx.args[0] instanceof URL) {
                ctx.args[0] = (0,_shared__WEBPACK_IMPORTED_MODULE_1__.rewriteUrl)(ctx.args[0].toString(), client.meta);
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self1) {
    let worker;
    if (self1.Worker && (0,_scramjet__WEBPACK_IMPORTED_MODULE_0__.flagEnabled)("syncxhr", client.url)) {
        worker = new nativeworker(_shared__WEBPACK_IMPORTED_MODULE_1__.config.files.sync);
    }
    ...
    if (___WEBPACK_IMPORTED_MODULE_0__.iswindow) {
        ...
        client.Proxy("SharedWorker", {
            construct ({ args, call }) {
                ...
                (async ()=>{
                    const port = await conn.getInnerPort();
                    sharedworkerpostmessage.call(worker.port, {
                        $scramjet$type: "baremuxinit",
                        port
                    }, [
                        port
