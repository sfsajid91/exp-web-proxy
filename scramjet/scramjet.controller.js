...
/* ESM import */var _frame__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./frame */ "./src/controller/frame.ts");
/* provided dependency */ var dbg = __webpack_require__(/*! ./src/log.ts */ "./src/log.ts")["default"];
...
class ScramjetController {
    ...
    constructor(config){
        ...
        _scramjet__WEBPACK_IMPORTED_MODULE_0__.$scramjet.config = deepMerge(defaultConfig, config);
    }
    ...
    encodeUrl(url) {
        if (url instanceof URL) url = url.toString();
        return _scramjet__WEBPACK_IMPORTED_MODULE_0__.$scramjet.config.prefix + _scramjet__WEBPACK_IMPORTED_MODULE_0__.$scramjet.codec.encode(url);
    }
    async openIDB() {
    ...
    async #saveConfig() {
        ...
        const req = store.put(_scramjet__WEBPACK_IMPORTED_MODULE_0__.$scramjet.config, "config");
        return new Promise((resolve, reject)=>{
    ...
    async modifyConfig(config) {
        _scramjet__WEBPACK_IMPORTED_MODULE_0__.$scramjet.config = Object.assign({}, _scramjet__WEBPACK_IMPORTED_MODULE_0__.$scramjet.config, config);
        (0,_scramjet__WEBPACK_IMPORTED_MODULE_0__.loadCodecs)();
        await this.#saveConfig();
    }
}
