...
async function swfetch(request, client) {
    ...
    try {
        ...
        return (0,_error__WEBPACK_IMPORTED_MODULE_0__.renderError)(err, (0,_shared__WEBPACK_IMPORTED_MODULE_1__.unrewriteUrl)(request.url));
    }
}
...
async function rewriteBody(response, meta, destination, workertype, cookieStore) {
    switch(destination){
        ...
        case "script":
            return (0,_shared__WEBPACK_IMPORTED_MODULE_1__.rewriteJs)(await response.arrayBuffer(), meta);
        case "style":
            return (0,_shared__WEBPACK_IMPORTED_MODULE_1__.rewriteCss)(await response.text(), meta);
        case "sharedworker":
        case "worker":
            return (0,_shared__WEBPACK_IMPORTED_MODULE_1__.rewriteWorkers)(await response.arrayBuffer(), workertype, meta);
        default:
            return response.body;
    }
}
...
class ScramjetServiceWorker extends EventTarget {
    ...
    async fetch({ request, clientId }) {
        ...
        return _fetch__WEBPACK_IMPORTED_MODULE_1__.swfetch.call(this, request, client);
    }
}
// @ts-ignore
